"""Gazebo simulation of the HAUV.
    ...
    ros2 launch hauv_gazebo_v2 hauv_sim.launch.py bridges:=false
...
def generate_launch_description():
    share = get_package_share_directory('hauv_gazebo_v2')
    urdf = os.path.join(share, 'urdf', 'hauv_gazebo_v2.urdf')
