...
#
#   wsl -d Ubuntu-Foxy -- bash "/mnt/c/Users/matma/Desktop/rov_ws - Copilot/src/hauv_gazebo_v2/run_sim.sh"          # with GUI
...
echo ""
exec ros2 launch hauv_gazebo_v2 hauv_sim.launch.py gui:=$GUI
